...
{
    public partial class AddedAuctionOwnerAndWinner : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuctionID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuctionOwner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuctionWinner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Current_bid = table.Column<int>(type: "int", nullable: false),
